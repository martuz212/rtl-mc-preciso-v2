...
if puntos_file and lineas_file:
    ...
    for i, b in enumerate(bloques):
        ...
        error_pct = (diff / dist_calc_sum) * 100 if dist_calc_sum != 0 else 0
    ...
    estado_global = "❌ RTL NO VIABLE" if len(errores) > 0 else "✅ RTL APROBADO"
    ...
    for b in bloques:
        ...
        for t in b[1:]:
            ...
            if cond_longitud or cond_densidad or (cond_quiebre and dist_acum > 120):
                ...
                salida += (
                    f"{'Inicia' if primera else 'Continúa'} en el punto {p_ini} con coordenadas planas N= {f(N_ini)} m, E= {f(E_ini)} m, "
